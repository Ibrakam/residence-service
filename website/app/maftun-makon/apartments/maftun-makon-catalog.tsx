...
const copy = {
  ru: {
    ...
    filters: 'Фильтры', rooms: 'Комнаты', allRooms: 'Все', areaFrom: 'Площадь от, м²', areaTo: 'Площадь до, м²', priceFrom: 'Цена от, млрд', priceTo: 'Цена до, млрд', floor: 'Этаж', allFloors: 'Все этажи', building: 'Дом', allBuildings: 'Все дома', propertyClass: 'Класс', allClasses: 'Все классы', reset: 'Сбросить',
  ...
  uz: {
    ...
    filters: 'Filtrlar', rooms: 'Xonalar', allRooms: 'Barchasi', areaFrom: 'Maydon, m² dan', areaTo: 'Maydon, m² gacha', priceFrom: 'Narx, mlrd dan', priceTo: 'Narx, mlrd gacha', floor: 'Qavat', allFloors: 'Barcha qavatlar', building: 'Uy', allBuildings: 'Barcha uylar', propertyClass: 'Toifa', allClasses: 'Barcha toifalar', reset: 'Tozalash',
  ...
  en: {
    ...
    filters: 'Filters', rooms: 'Rooms', allRooms: 'All', areaFrom: 'Area from, m²', areaTo: 'Area to, m²', priceFrom: 'Price from, bn', priceTo: 'Price to, bn', floor: 'Floor', allFloors: 'All floors', building: 'Building', allBuildings: 'All buildings', propertyClass: 'Class', allClasses: 'All classes', reset: 'Reset',
