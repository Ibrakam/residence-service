...
const officialLanding = 'https://nrg-bi.uz/uz-ru/landing/sado';
...
const copy = {
  ru: {
    ...
    map: 'Открыть официальный проект', booklet: 'Скачать буклет',
    ...
    officialProgress: 'Официальный отчёт', panorama: 'Панорама 360°', camera: 'Онлайн-камера', cameraUnavailable: 'Поток временно недоступен · проверено 30.08.2026',
