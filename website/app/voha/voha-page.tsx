...
const officialLanding = 'https://nrg-bi.uz/uz-ru/landing/voha';
...
const copy = {
  ru: {
    ...
    clubTop: '05 · Клубная среда', clubTitle: 'Пространства для жителей.', clubText: 'Официальная страница проекта заявляет Gentlemen’s club, фитнес-залы, детскую комнату и финскую парную. Буклет также показывает кинотеатр. Актуальную доступность конкретной зоны подтверждает отдел продаж.', clubItems: ['Gentlemen’s club', 'Фитнес-залы', 'Детская комната', 'Финская парная', 'Кинотеатр'],
    ...
    serviceTop: '07 · Управление', serviceTitle: 'Сервис как спокойная ежедневная работа.', serviceText: 'Управляющая компания отвечает за чистоту, безопасность, инженерные системы и уход за ландшафтом.', serviceRate: 'На официальной странице 30.08.2026 указаны предварительные платежи: квартира — 18 500 сум/м², офис — 19 772 сум/м², паркинг — 361 714 сум за место. Тарифы не являются офертой и требуют актуального подтверждения.',
    locationTop: '08 · Локация', locationTitle: 'Ташкент, улица Кайнарсой, 136А.', locationText: 'Это адрес, опубликованный на официальной странице проекта. В официальном каталоге параллельно отображается адрес «ул. Карасу Буйи, 21» — перед визитом уточните нужную точку у отдела продаж.', map: 'Открыть Voha в 2GIS', offices: 'Отделы продаж',
    ...
    contactTop: '12 · Персональная консультация', contactTitle: 'Найдите своё место у воды.', contactText: 'Оставьте контакты — менеджер проекта подтвердит актуальные условия и детали выбранного предложения.', phone: 'Телефон', source: 'Официальная страница', privacy: 'Конфиденциальность',
  ...
  uz: {
    ...
    clubTop: '05 · Klub muhiti', clubTitle: 'Rezidentlar uchun makonlar.', clubText: 'Rasmiy sahifada Gentlemen’s club, fitnes zallari, bolalar xonasi va fin bug‘xonasi ko‘rsatilgan. Bukletda kinoteatr ham bor. Amaldagi mavjudlikni sotuv bo‘limidan tasdiqlang.', clubItems: ['Gentlemen’s club', 'Fitnes zallari', 'Bolalar xonasi', 'Fin bug‘xonasi', 'Kinoteatr'],
    ...
    serviceTop: '07 · Boshqaruv', serviceTitle: 'Servis — kundalik sokin mehnat.', serviceText: 'Boshqaruv kompaniyasi tozalik, xavfsizlik, muhandislik tizimlari va landshaft parvarishiga javob beradi.', serviceRate: '30.08.2026 rasmiy sahifasidagi dastlabki to‘lovlar: xonadon — 18 500 so‘m/m², ofis — 19 772 so‘m/m², parking — 361 714 so‘m/joy. Tariflarni qayta tasdiqlash kerak.',
    locationTop: '08 · Joylashuv', locationTitle: 'Toshkent, Qaynorsoy ko‘chasi, 136A.', locationText: 'Rasmiy loyiha sahifasidagi manzil. Rasmiy katalogda bir vaqtning o‘zida “Qorasuv bo‘yi ko‘chasi, 21” ko‘rsatiladi — tashrifdan oldin nuqtani aniqlang.', map: 'Voha’ni 2GIS’da ochish', offices: 'Sotuv bo‘limlari',
    ...
    contactTop: '12 · Shaxsiy maslahat', contactTitle: 'Suv bo‘yidagi o‘z joyingizni toping.', contactText: 'Kontakt qoldiring — loyiha menejeri amaldagi shartlar va tanlangan taklif tafsilotlarini tasdiqlaydi.', phone: 'Telefon', source: 'Rasmiy sahifa', privacy: 'Maxfiylik',
  ...
  en: {
    ...
    clubTop: '05 · Club environment', clubTitle: 'Spaces for residents.', clubText: 'The official page lists a Gentlemen’s club, gyms, a children’s room and a Finnish steam room. The brochure also shows a cinema. Confirm current access with the sales team.', clubItems: ['Gentlemen’s club', 'Gyms', 'Children’s room', 'Finnish steam room', 'Cinema'],
    ...
    serviceTop: '07 · Management', serviceTitle: 'Service as calm, daily work.', serviceText: 'The management company covers cleanliness, safety, engineering systems and landscape care.', serviceRate: 'Preliminary payments shown on the official page on 30 Aug 2026: apartment — UZS 18,500/m², office — UZS 19,772/m², parking — UZS 361,714/space. Reconfirm current tariffs.',
    locationTop: '08 · Location', locationTitle: '136A Qaynorsoy Street, Tashkent.', locationText: 'This is the address published on the official project page. The official catalogue also displays “21 Karasu Buyi Street”; confirm the correct point before visiting.', map: 'Open Voha in 2GIS', offices: 'Sales offices',
    ...
    contactTop: '12 · Personal consultation', contactTitle: 'Find your place by the water.', contactText: 'Leave your details and the project manager will confirm current terms and the selected listing.', phone: 'Phone', source: 'Official page', privacy: 'Privacy',
...
export function VohaPage({ initialLanguage = 'ru' }: { initialLanguage?: Language }) {
  ...
  return <main className="voha-site" lang={language}>
    ...
    <footer className="voha-footer"><a className="voha-wordmark" href={withLanguage('/voha', language)}>VOHA<small>by NRG-BI</small></a><div><a href="tel:1360">{t.phone} · 1360</a><a href={officialLanding} target="_blank" rel="noreferrer">{t.source} ↗</a><a href={`${appBasePath}/privacy?project=voha&lang=${language}`}>{t.privacy}</a></div><p>© 2026 · Информация не является публичной офертой.</p></footer>
