...
console.log(`Saadiyat contract passed: ${snapshot.units.length} AVAILABLE residential entries, ${new Set(snapshot.units.map((unit) => unit.plan)).size} local plans, prices hidden, exact lead context and live document language enabled.`);
